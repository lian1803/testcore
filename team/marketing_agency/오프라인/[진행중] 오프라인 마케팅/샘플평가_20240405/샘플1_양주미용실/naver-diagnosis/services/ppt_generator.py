...
PACKAGE_PRICES = {
    '시선패키지': {'정상가': '890,000', '약정가': '890,000', '합계6개월': '5,340,000'},  # 시선 89만원/월
    '집중패키지': {'정상가': '490,000', '약정가': '490,000', '합계6개월': '2,940,000'},  # 집중 49만원/월
    '주목패키지': {'정상가': '290,000', '약정가': '290,000', '합계6개월': '1,740,000'},  # 주목 29만원/월
}
