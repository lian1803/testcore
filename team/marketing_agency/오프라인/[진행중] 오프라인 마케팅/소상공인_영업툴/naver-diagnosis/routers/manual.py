...
async def create_manual_diagnosis(
    ...
    try:
        ...
        history = DiagnosisHistory(
            ...
            own_brand_search_volume=own_brand_search_volume,
        )
        db.add(history)
        await db.commit()
